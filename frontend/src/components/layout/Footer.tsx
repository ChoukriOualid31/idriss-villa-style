        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              ...
              Excellence, qualité et service premium depuis plus de 10 ans.
            </p>
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 bg-dark-800 rounded-lg flex items-center justify-center text-gray-400 hover:bg-gold-500 hover:text-dark-950 transition-all"
              >
        ...
        <div className="border-t border-dark-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} Idriss Villa Style. Tous droits réservés.
            </p>
